  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-initial">
        ...
        {user && (
          <div className={classes.profile}>
	      <Typography className={`flex items-center text-white`} variant="h6">Profile: {profileName}</Typography>
	      <Typography className={`flex items-center text-white`} variant="h6">You: {user}</Typography>
	      <Typography className={`flex items-center text-white`} variant="h6">Ai character: {bot}</Typography>
	  </div>
	)}
        {(
